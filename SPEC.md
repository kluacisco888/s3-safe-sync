...
- If an editor save changes a file after planning but before its upload or conflict preparation, treat it as a local change and retry after edits settle. Do not publish the stale planned content or show a generic sync error for this race.
